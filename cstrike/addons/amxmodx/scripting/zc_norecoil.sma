...
public plugin_init()
{
	register_plugin("[ZC No Recoil]", "0.1.0", "CarsonMotion")
	g_itemid_norecoil = zp_register_extra_item("No Recoil", 20, ZP_TEAM_HUMAN, REST_NONE, 0)
	new weapon_name[24]
	for (new i = 1; i <= 30; i++)
	{
...
public zp_extra_item_selected(player, itemid)
{
	if (itemid == g_itemid_norecoil)
	{
		...
		colored_print(player, GREEN, "[ZC]^x01 You have bought^x04 No Recoil^x01 for your weapon!")
	}
}
