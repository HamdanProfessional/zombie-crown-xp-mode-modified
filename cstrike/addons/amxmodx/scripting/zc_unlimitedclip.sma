...
public plugin_init()
{
	register_plugin("[ZC Unlimited Clip]", "1.0", "MeRcyLeZZ")
	g_itemid_infammo = zp_register_extra_item("Unlimited Clip", 25, ZP_TEAM_HUMAN, REST_NONE, 0)
...
{
	if (itemid == g_itemid_infammo && !g_has_unlimited_clip[player])
