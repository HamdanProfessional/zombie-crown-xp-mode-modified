...
new const UnPrecache_ModelList[18][] =
{
...
new const UnPrecache_SoundList[105][] =
{
...
public plugin_init() 
{
	...
	server_print("[ZC] Model Precache Reserved Slots: %i", 512 - ArraySize(ArModel))
	server_print("[ZC] Sound Precache Reserved Slots: %i", 512 - ArraySize(ArSound))
}
...
public fw_PrecacheSound_Post(const Sound[])
{
	...
	if(!Precached) 
	{
		...
		Line++
		write_file("Sound.txt", Sound, Line)
	}
