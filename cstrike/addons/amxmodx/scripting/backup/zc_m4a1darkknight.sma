...
#define PLUGIN "[ZC] M4A1 Dark Knight" 
#define VERSION "1.0"
...
// Weapon Config
#define DAMAGE_A 90 // 60 for Zombie
#define DAMAGE_B 60 // 200 for Zombie
#define ACCURACY 70 // 0 - 100 ; -1 Default
#define CLIP 50
#define BPAMMO 250
#define SPEED_A 0.0875
#define SPEED_B 0.0425
#define RECOIL 0.75
...
public plugin_init()
{
	...
	// Get
	g_itemid = zp_register_extra_item("M4a1 Dark Knight", 10, ZP_TEAM_HUMAN, REST_NONE, 2)
}
