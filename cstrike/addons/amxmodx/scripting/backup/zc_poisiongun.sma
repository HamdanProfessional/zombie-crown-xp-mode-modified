...
#define DAMAGE 25
#define FIRE_SPEED 1000
#define RECOIL 0.0
#define CLIP 100
#define BPAMMO 200

#define AFTERPOISON_TIME 10.0
#define AFTERPOISON_DAMAGE 100
...
public plugin_init()
{
	...
	g_itemid = zp_register_extra_item("Poision Gun", 10, ZP_TEAM_HUMAN, REST_NONE, 2)
}
