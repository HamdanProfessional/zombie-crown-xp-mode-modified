...
#define PLUGIN "[ZC Cannon]"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define V_MODEL "models/zombie_crown/v_cannon.mdl"
#define P_MODEL "models/p_mp5.mdl"
#define W_MODEL "models/zombie_crown/w_cannon.mdl"

#define is_valid_alive(%1) (1 <= %1 <= g_MaxPlayers && is_user_alive(%1))

#define DAMAGE 1050
#define RADIUS 405
#define CANNON_ROUND 120
...
{
	register_native("give_weapon_cannon", "native_give_weapon_add", 1)
}
...
public plugin_precache()
{
	...
	{
		engfunc(EngFunc_PrecacheGeneric, WeaponResources[i])
	}
...
public Event_CurWeapon(id)
{
	...
	if((CSWID == CSW_CANNON) && Get_BitVar(g_Had_Cannon, id))
	{
		...
		set_pdata_string(id, (492) * 4, WEAPON_ANIMEXT, -1, 120)
