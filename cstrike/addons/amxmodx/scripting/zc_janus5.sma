...
#define SUBMODEL 6
#define V_MODEL "models/zombie_crown/v_janusmk5.mdl"
#define P_MODEL "models/p_m4a1.mdl"
...
new g_Event_Janus5, g_SmokePuff_SprId, g_RifleShell_Id, g_ham_bot, g_MsgWeaponList
...
{
	register_native("give_weapon_janus5", "native_give_weapon_add", 1)
}
...
public plugin_precache()
{
	...
	precache_generic( "sprites/weapon_janus5.txt" )
	precache_generic( "sprites/640hud69_2.spr" )
	precache_generic( "sprites/640hud2.spr" )
	register_clcmd("weapon_janus5", "HookWeapon")
}
