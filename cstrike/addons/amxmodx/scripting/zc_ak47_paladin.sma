...
// Weapon Config
#define DAMAGE_A 120// 66 for Zombie
#define DAMAGE_B 800 // 360 for Zombie
...
public plugin_init()
{
	...
	// Get
	g_itemid = zp_register_extra_item("Ak47 Paladin", 10, ZP_TEAM_HUMAN, REST_NONE, 2)
}
