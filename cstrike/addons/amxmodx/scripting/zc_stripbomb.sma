...
new const model_grenade_infect[] = "models/v_hegrenade.mdl"
new const bcost = 60;

new g_trailSpr, g_exploSpr, stripbmb, cvar_enabled, cvar_mode, cvar_radius
new has_bomb[33]

public plugin_init()
{
	register_plugin("[ZC Strip Bomb]", "1.6", "Hezerf")
...
public plugin_precache()
{
	...
	stripbmb = zp_register_extra_item("Strip Bomb", bcost, ZP_TEAM_ZOMBIE, REST_MAP, 10)
}
