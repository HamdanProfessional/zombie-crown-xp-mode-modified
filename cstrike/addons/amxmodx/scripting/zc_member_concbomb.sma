...
// Grenade cost
#define GRENADE_COST	45

// Grenade models - not precached
...
public plugin_init ()
{
	register_plugin ("[ZC CONC BOMB]", VERSION, "NiHiLaNTh")
	
	// New extra item
	g_conc = zv_register_extra_item ("Concussion Grenade", GRENADE_COST, ZV_TEAM_ZOMBIE, REST_MAP, 5)
