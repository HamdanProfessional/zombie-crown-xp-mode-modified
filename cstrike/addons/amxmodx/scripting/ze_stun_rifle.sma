...
#define WEAPON_DAMAGE 3.0 // AK47 damage multiplied by this factor

#define WEAPON_RATE_EX 0.169
#define WEAPON_RECOIL_EX 0.79
#define WEAPON_DAMAGE_EX 5
...
public plugin_init()
{
	register_plugin("[ZC] Stun Rifle", "1.1", "n00bi2763");

	// Register our item
	g_itemid = zp_register_extra_item("Stun Rifle", 15, ZP_TEAM_HUMAN, REST_NONE, 2)
...
public zp_user_infected(infected)
{
...
public zp_extra_item_selected(player, itemid)
{
	if (itemid == g_itemid)
	{
		give_stunrifle(player)
		return PLUGIN_HANDLED
	}
	return PLUGIN_CONTINUE
}

public zp_user_humanized(id)
{
